        ...
        <table className="w-full text-[15px] text-left border-collapse">
          <thead>
            <tr className="border-b border-gray-100 bg-gray-50/50">
              <th className="px-7 py-5 text-[13px] font-bold text-gray-400 uppercase tracking-wider">NO AWB</th>
              <th className="px-7 py-5 text-[13px] font-bold text-gray-400 uppercase tracking-wider">PENGIRIM</th>
              <th className="px-7 py-5 text-[13px] font-bold text-gray-400 uppercase tracking-wider">TUJUAN</th>
              <th className="px-7 py-5 text-[13px] font-bold text-gray-400 uppercase tracking-wider">BERAT</th>
              <th className="px-7 py-5 text-[13px] font-bold text-gray-400 uppercase tracking-wider">PENERBANGAN</th>
              <th className="px-7 py-5 text-[13px] font-bold text-gray-400 uppercase tracking-wider">STATUS</th>
              <th className="px-7 py-5 text-[13px] font-bold text-gray-400 uppercase tracking-wider">WAKTU UPDATE</th>
              <th className="px-7 py-5 text-[13px] font-bold text-gray-400 uppercase tracking-wider text-center">AKSI</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-50 bg-white">
            {paginatedData.length === 0 ? (
              <tr>
                <td colSpan={8} className="px-7 py-16 text-center text-[15px] text-gray-400">
              ...
              return (
                <tr key={resiCode || i} className="hover:bg-blue-50/10 transition group">
                  <td className="px-7 py-5 font-mono text-blue-600 font-semibold tracking-tight whitespace-nowrap">
                    {resiCode}
                  </td>
                  <td className="px-7 py-5 text-gray-700 font-medium whitespace-nowrap">
                    {pengirim}
                  </td>
                  <td className="px-7 py-5 text-gray-500 font-medium whitespace-nowrap">
                    {tujuan}
                  </td>
                  <td className="px-7 py-5 text-gray-600 whitespace-nowrap">
                    {berat}
                  </td>
                  <td className="px-7 py-5 text-gray-500 font-mono whitespace-nowrap">
                    {armada}
                  </td>
                  <td className="px-7 py-5 whitespace-nowrap">
                    <span className={`text-[13px] font-bold px-3 py-1.5 rounded-full ${badgeStyle[statusKargo] || 'bg-gray-100 text-gray-600'}`}>
                      {statusKargo}
                    </span>
                  </td>
                      ...
                      <div className="flex items-center justify-center gap-1.5">
                        {actionMode === 'detail' ? (
                          <Link
                            ...
                            className="inline-flex items-center gap-1.5 text-[13px] font-bold text-sky-700 hover:text-sky-900 bg-sky-50 hover:bg-sky-100 px-3 py-2 rounded-lg border border-sky-100/60 transition uppercase"
                          >
                          ...
                          <>
                            <Link
                              ...
                              className="inline-flex items-center gap-1.5 text-[13px] font-bold text-blue-600 hover:text-blue-800 bg-blue-50/60 hover:bg-blue-100 px-3 py-2 rounded-lg border border-blue-100/50 transition uppercase"
                            >
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4 h-4">
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 text-[13px] font-bold text-red-600 hover:text-red-800 bg-red-50 hover:bg-red-100 px-3 py-2 rounded-lg border border-red-100/50 transition uppercase disabled:opacity-50"
                            >
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4 h-4">
        ...
        {totalPages > 1 && (
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="px-3.5 py-2 text-gray-500 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 disabled:opacity-40 transition"
            >
              ← Sebelumnya
            </button>
            <div className="flex items-center gap-1">
              {Array.from({ length: totalPages }, (_, idx) => (
                <button
                  ...
                  className={`w-8 h-8 rounded-lg text-center font-bold transition ${currentPage === idx + 1 ? 'bg-blue-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50 border border-gray-200'}`}
                >
                  {idx + 1}
                </button>
              ))}
